...
class MainScene:
    def __init__(self, switch_scene):
        ...
        self.buttons = [
            Button(0, 0, 200, 50, pygame.Color(255, 255, 255, 0), text="Play"),
            Button(0, 50, 200, 50, (0, 200, 0), text="Settings"),
            Button(0, 100, 200, 50, (200, 0, 0), text="Quit"),
        ]
        self.background = pygame.image.load("main_scene_bg.png").convert_alpha()
...
class SettingsScene:
    def __init__(self, switch_scene, game_data):
        ...
        self.back_button = Button(10, 10, 100, 50, pygame.Color(255, 255, 255, 0), text="Back")
        self.background = pygame.image.load("settings_scene_bg.png").convert_alpha()
        self.canvas_layer = pygame.Surface((LOGICAL_WIDTH, LOGICAL_HEIGHT), pygame.SRCALPHA)
...
def main():
    ...
    logical_surface = pygame.Surface((LOGICAL_WIDTH, LOGICAL_HEIGHT), pygame.SRCALPHA)
    current_scene = None
    game_data = load_game()
